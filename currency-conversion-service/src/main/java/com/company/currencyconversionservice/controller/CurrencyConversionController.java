package com.company.currencyconversionservice.controller;

import com.company.currencyconversionservice.client.CurrencyExchangeProxy;
...
public class CurrencyConversionController {
    ...
    public CurrencyConversion calculateCurrencyConversion(@PathVariable String from,
        ...
        ResponseEntity<CurrencyConversion> entity =
                new RestTemplate()
                        .getForEntity("http://localhost:8076/currency-exchange/from/{from}/to/{to}",
